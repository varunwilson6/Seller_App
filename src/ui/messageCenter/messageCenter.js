...
import {View,Text,TextInput,AsyncStorage,TouchableOpacity,ScrollView,Image,Platform} from 'react-native'
  ...
  answerDemo(messages) {
    if (messages.length > 0) {
      if ((messages[0].image || messages[0].location) || !this._isAlright) {
        this.setState((previousState) => {
          return {
            typingText: this.props.title+' is typing'
          };
        });
      }
    }
        ...
        if (messages.length > 0) {
          if (messages[0].image) {
            ...
            if (!this._isAlright) {
              ...
              this.onReceive('Hi.. How can I help you?');
            }
          }
        }
      }
